...
const stampAndSignParams = (params) => {
...
const signedConnectUrlForUser = (user) => {
...
const signedConfigurationUrlForUser = (user) => {
...
module.exports = {
  ...
  areParamsValid,
  stampAndSignParams,
  signedConnectUrlForUser,
  signedConfigurationUrlForUser
}
